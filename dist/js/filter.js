...
Nova.booting(function (Vue) {
    Vue.component('multiselect-filter', __webpack_require__(2));
});
...
var update = __webpack_require__(6)("f3071e4e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1dedfda3\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1dedfda3\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_multiselect__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.filter.options.forEach(function (option) {
      if (_this.filter.currentValue.indexOf(option.value) === -1) {
        return;
      }
  ...
  computed: {
    ...
    clearOnSelect: function clearOnSelect() {
        ...
        _c("multiselect", {
          ...
          scopedSlots: _vm._u([
            ...
            },
            {
              key: "noResult",
              fn: function() {
                return [_vm._v(_vm._s(_vm.noResultLabel))]
              },
              proxy: true
            }
          ]),
